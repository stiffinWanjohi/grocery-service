...
func (_m *ProductRepository) ListByCategoryID(ctx context.Context, categoryID string) ([]domain.Product, error) {
...
func (_m *ProductRepository) UpdateStock(ctx context.Context, id string, quantity int) error {
