...
func (_m *CategoryService) Delete(ctx context.Context, id string) error {
...
func (_m *CategoryService) GetByID(ctx context.Context, id string) (*domain.Category, error) {
	ret := _m.Called(ctx, id)
...
func (_m *CategoryService) ListByParentID(ctx context.Context, parentID string) ([]domain.Category, error) {
