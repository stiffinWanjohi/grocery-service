...
type (
	TokenRepository interface {
		...
		GetByUserAndType(ctx context.Context, userID string, tokenType domain.TokenType) (*domain.Token, error)
		GetByProviderID(ctx context.Context, providerID string) (*domain.Token, error)
...
func NewTokenRepository(postgres *db.PostgresDB) *TokenRepositoryImpl {
	return &TokenRepositoryImpl{
		BaseRepository: db.NewBaseRepository[domain.Token](postgres),
	}
}

func (r *TokenRepositoryImpl) Create(ctx context.Context, token *domain.Token) error {
	return r.BaseRepository.WithTransaction(ctx, func(txRepo *db.BaseRepository[domain.Token]) error {
...
func (r *TokenRepositoryImpl) GetByToken(ctx context.Context, token string) (*domain.Token, error) {
	var t domain.Token
...
func (r *TokenRepositoryImpl) GetByUserAndType(ctx context.Context, userID string, tokenType domain.TokenType) (*domain.Token, error) {
	var t domain.Token
	err := r.BaseRepository.GetDB().WithContext(ctx).
...
func (r *TokenRepositoryImpl) GetByProviderID(ctx context.Context, providerID string) (*domain.Token, error) {
	var t domain.Token
	err := r.BaseRepository.GetDB().WithContext(ctx).
...
func (r *TokenRepositoryImpl) RevokeToken(ctx context.Context, token string) error {
	now := time.Now()
	return r.BaseRepository.WithTransaction(ctx, func(txRepo *db.BaseRepository[domain.Token]) error {
...
func (r *TokenRepositoryImpl) IsValid(ctx context.Context, token string) bool {
	var t domain.Token
	err := r.BaseRepository.GetDB().WithContext(ctx).
